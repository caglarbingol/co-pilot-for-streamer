...
pub mod operations_client {
    ...
    #[doc = " to return [Operation][google.longrunning.Operation] to the client, and the"]
    #[doc = " client can use this interface to receive the real response asynchronously by"]
    #[doc = " polling the operation resource, or pass the operation resource to another API"]
    #[doc = " (such as Pub/Sub API) to receive the response.  Any API service that returns"]
    #[doc = " long-running operations should implement the `Operations` interface so"]
    #[doc = " developers can have a consistent client experience."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " an [Operation.error][google.longrunning.Operation.error] value with a"]
